...
$mail->Host = 'smtp.outlook.live.com';  																							// Specify main and backup SMTP servers
...
$mail->Port = 443; // TCP port to connect to / этот порт может отличаться у других провайдеров
